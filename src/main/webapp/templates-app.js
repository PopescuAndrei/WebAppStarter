angular.module('templates-app', ['pages/about.tpl.html', 'pages/home.tpl.html']);

angular.module("pages/about.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("pages/about.tpl.html",
    "<div class=\"row\">\n" +
...
angular.module("pages/home.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("pages/home.tpl.html",
    "<div class=\"jumbotron\">\n" +
